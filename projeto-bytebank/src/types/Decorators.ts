// os parametros definidos na construcao da funcao do dacorator foi definido e recomendado pela própria documentação do TS
export function ValidaDebito(
  ...
  descriptor.value = function (valorDoDebito: number) {
    ...
    if (valorDoDebito > this.saldo) {
      throw new Error("Seu saldo é insuficiente para realizar esta operação.");
    }
